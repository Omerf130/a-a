...
const MainPage = () => {
  return (
    <div className='main-page-container'>
      ...
      <Articles slides={propertyData} title="מאמרים בנושא מקרקעין, בתים משותפים וליקויי בנייה" sectionName="propertySection"/>
      <Succsses componentType="house" data={successHouseData} title="הצלחות המשרד בתחום המקרקעין, בתים משותפים וליקויי בנייה"/>
